package com.example.misson10_2;
...
public class ResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Integer imageFileId[] = {R.drawable.reading_book, R.drawable.flower_hat,
                R.drawable.fan_girl, R.drawable.irene_kang, R.drawable.sleep_girl,
                R.drawable.terrace, R.drawable.piano_lesson, R.drawable.sleep_girl,
                R.drawable.beach};
